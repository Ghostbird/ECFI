...
# debug writer
eval 'gdb -ex "set env LD_PRELOAD bin/lib/libringbuffer.so" -ex "file bin/cfi-checker" -ex "b main" -ex "b *0x0001124c" -ex "run '$@' " -ex "continue" -ex "set follow-fork-mode child" -ex "continue"'
# debug reader
